...
const Settings = () => {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            try {
                const response = await axios.get('https://api.tokofairy.my.id/get-banners');
    ...
    const handleUploadImage = async () => {
        ...
        try {
            ...
            const response = await axios.post('https://api.tokofairy.my.id/upload-banner', formData, {
                headers: {
            ...
            const refreshedImages = await axios.get('https://api.tokofairy.my.id/get-banners');
